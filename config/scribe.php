...
return [
     ...
     */
    'title' => 'Election Violence Tracker API Documentation',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => "The election violence tracker is an open source reporting tool that enables citizens to document and report violent incedents during Nigeria's election.",
